...
export default function ConfigPanel() {
  ...
  return (
    <div className="
      mx-auto w-full p-8 rounded-3xl shadow-sci-fi-glow
      bg-sci-fi-bg/50
    ">
      ...
      <div className="mb-4">
        ...
        <input value={modelPath}
               ...
               className="w-full px-4 py-2 rounded bg-black bg-opacity-60 text-sci-fi-blue text-sm
               focus:outline-none focus:ring-1 focus:ring-sci-fi-blue
               hover:shadow-sci-fi-glow" />
      </div>
